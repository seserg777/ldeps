...
class ProductController extends Controller
{
    ...
    public function index(ProductFilterRequest $request)
    {
        ...
        if ($request->ajax()) {
            return response()->json([
                'products' => $products,
                'products_html' => view('products.partials.product-grid', compact('products'))->render(),
                'filters' => [
        ...
        return view('products.index-new', compact('products', 'manufacturers', 'priceRange', 'categories'));
    }
    ...
    public function category(string $path): View
    {
        ...
        return view('products.index-new', compact('products', 'manufacturers', 'priceRange', 'categories', 'category', 'childCategories', 'filteredExtraFieldValue', 'filteredManufacturer', 'filterParam'));
    }
    ...
    public function getProducts(Request $request): JsonResponse
    {
        ...
        return response()->json([
            'html' => view('products.partials.product-grid', ['products' => $products])->render(),
            'pagination' => view('products.partials.pagination', ['products' => $products])->render(),
