...
class SaleBannerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('sale-banners.index', compact('saleBanners', 'tags'));
    }
    ...
    public function show($alias)
    {
        ...
        return view('sale-banners.show', compact('saleBanner', 'relatedBanners'));
    }
    ...
    public function tag($tagAlias)
    {
        ...
        return view('sale-banners.tag', compact('saleBanners', 'tag', 'tags'));
    }
