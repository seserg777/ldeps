    ...
    <header>
      <div class="container py-2">
        <div class="row">
          ...
          <div class="col-3">
            <search-module placeholder="Search"></search-module>
          </div>
        </div>
      </div>
    </header>
