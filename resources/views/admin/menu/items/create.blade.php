        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Создать пункт меню: {{ $menuType->title }}</h3>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.menu.items.store', $menuType->menutype) }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" 
                                           ...
                                           name="link" 
                                           value="{{ old('link') }}" 
                                           placeholder="/products/category/example"
                                           required>
                                    @error('link')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('type') is-invalid @enderror" 
                                        ...
                                        <option value="Alias" {{ old('type') == 'Alias' ? 'selected' : '' }}>Псевдоним</option>
                                        <option value="Separator" {{ old('type') == 'Separator' ? 'selected' : '' }}>Разделитель</option>
                                    </select>
                                    @error('type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('parent_id') is-invalid @enderror" 
                                            ...
                                            name="parent_id" 
                                            required>
                                        <option value="1" {{ old('parent_id', 1) == 1 ? 'selected' : '' }}>Корневой уровень</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('access') is-invalid @enderror" 
                                            ...
                                            name="access" 
                                            required>
                                        <option value="0" {{ old('access', 0) == 0 ? 'selected' : '' }}>Публичный</option>
                                        <option value="1" {{ old('access') == 1 ? 'selected' : '' }}>Зарегистрированные</option>
                                        <option value="2" {{ old('access') == 2 ? 'selected' : '' }}>Специальные</option>
                                        <option value="3" {{ old('access') == 3 ? 'selected' : '' }}>Супер пользователи</option>
                                    </select>
                                    @error('access')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('language') is-invalid @enderror" 
                                        ...
                                        <option value="ru-RU" {{ old('language') == 'ru-RU' ? 'selected' : '' }}>Русский</option>
                                        <option value="uk-UA" {{ old('language') == 'uk-UA' ? 'selected' : '' }}>Украинский</option>
                                        <option value="en-GB" {{ old('language') == 'en-GB' ? 'selected' : '' }}>Английский</option>
                                    </select>
                                    @error('language')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Создать пункт меню
                            </button>
