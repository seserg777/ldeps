    ...
    <div class="container">
        <div class="mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Создать категорию</h1>
                    <p class="mt-1 text-sm text-gray-600">Добавление новой категории товаров</p>
                </div>
        ...
        <div class="bg-white shadow rounded-lg">
            <form action="{{ route('admin.categories.store') }}" method="POST" class="p-6">
                ...
                <div class="grid grid-cols-1 gap-6">
                    <div>
                        <label for="name" class="block text-sm font-medium text-gray-700">Название категории <span class="text-red-500">*</span></label>
                        <input type="text" 
                               name="name" 
                               id="name" 
                               value="{{ old('name') }}"
                            ...
                            <div class="mt-2">
                                <label class="inline-flex items-center">
                                    <input type="checkbox" 
                                           ...
                                           value="1"
                                           {{ old('category_publish', true) ? 'checked' : '' }}
