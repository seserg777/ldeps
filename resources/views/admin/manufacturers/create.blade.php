...
@section('title','Создать производителя')
    ...
    <div class="container">
        <div class="mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Создать производителя</h1>
                    <p class="mt-1 text-sm text-gray-600">Добавление нового производителя товаров</p>
                </div>
        ...
        <div class="bg-white shadow rounded-lg">
            <form action="{{ route('admin.manufacturers.store') }}" method="POST" class="p-6">
                @csrf
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <textarea name="description" 
                                  id="description" 
                                  rows="10"
                                  class="tinymce-editor @error('description') border-red-300 @enderror">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
